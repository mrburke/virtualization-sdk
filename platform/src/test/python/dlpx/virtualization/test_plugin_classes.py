...
class TestPluginClasses:
    ...
    def test_init_mount_bad_mount_path(remote_environment):
        ...
        if six.PY2:
            ...
            assert err_info.value.message == (
                "Mount's parameter 'mount_path' was class 'int' but should"
                " be of class 'str'.")
    ...
    def test_init_mount_bad_shared_path(remote_environment):
        ...
        if six.PY2:
            ...
            assert err_info.value.message == (
                "Mount's parameter 'shared_path' was class 'int' but should"
                " be of class 'str' if defined.")
    ...
    def test_init_ownership_spec_bad_uid():
        ...
        if six.PY2:
            ...
            assert err_info.value.message == (
                "OwnershipSpecification's parameter 'uid' was class 'str' but"
                " should be of class 'int'.")
    ...
    def test_init_ownership_spec_bad_gid():
        ...
        if six.PY2:
            ...
            assert err_info.value.message == (
                "OwnershipSpecification's parameter 'gid' was class 'str' but"
                " should be of class 'int'.")
    ...
    def test_init_mount_invalid_reference_type(reference):
        ...
        if six.PY2:
            ...
            assert err_info.value.message == (
                "Mount's parameter 'remote_environment' was class '{}' but "
                "should be of any one of the following types: "
                "'['dlpx.virtualization.common._common_classes.RemoteEnvironment',"
                " 'builtins.str']'.".format(type(reference).__name__))
    ...
    def test_init_mount_spec_mounts_not_list():
        ...
        if six.PY2:
            ...
            assert err_info.value.message == (
                "MountSpecification's parameter 'mounts' was class 'str' but"
                " should be of type 'list of dlpx.virtualization.platform"
                "._plugin_classes.Mount'.")
    ...
    def test_init_mount_spec_bad_mounts():
        ...
        if six.PY2:
            ...
            assert err_info.value.message == (
                "MountSpecification's parameter 'mounts' was a list of"
                " [class 'str'] but should be of type 'list of dlpx.virtualization"
                ".platform._plugin_classes.Mount'.")
